...
Proyecto ESP-IDF preparado para correr el modelo cuantizado de
`../training/outputs_tf/tflite/cnn_skip_pool_tf_int8.tflite` con TensorFlow Lite
Micro. Ese modelo ya esta convertido a arreglo C en
`main/identifier_model_data.cc`. El modelo espera imagenes monocromaticas de
`96x96` y entrega 4 clases:
