      ...
      <section className="grid">
        ...
        <div className="panel">
          ...
          <div className="telemetry">
            <div>
              <span>Ring</span>
              <strong className={`ring-state ${String(pose.ring_status).toLowerCase()}`}>
                {pose.ring_status}
              </strong>
            </div>
            <div>
              <span>Motion</span>
              <strong>{pose.motion}</strong>
            </div>
            <div>
              <span>V</span>
            ...
            <div>
              <span>ESP-NOW</span>
              <strong>{formatAge(pose.espnow_age_ms)}</strong>
            </div>
            <div>
              <span>Camera</span>
              <strong>{pose.camera_mac}</strong>
            </div>
          </div>
