...
CMakeFiles/bootloader-complete: bootloader-prefix/src/bootloader-stamp/bootloader-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'bootloader'"
	/usr/bin/cmake -E make_directory /home/diegolagos/esp_projects/robot_audio/build/CMakeFiles
	/usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/CMakeFiles/bootloader-complete
	/usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/src/bootloader-stamp/bootloader-done
...
bootloader-prefix/src/bootloader-stamp/bootloader-build: bootloader-prefix/src/bootloader-stamp/bootloader-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Performing build step for 'bootloader'"
	cd /home/diegolagos/esp_projects/robot_audio/build/bootloader && $(MAKE)
...
bootloader-prefix/src/bootloader-stamp/bootloader-configure: bootloader-prefix/src/bootloader-stamp/bootloader-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Performing configure step for 'bootloader'"
	cd /home/diegolagos/esp_projects/robot_audio/build/bootloader && /usr/bin/cmake -DSDKCONFIG=/home/diegolagos/esp_projects/robot_audio/sdkconfig -DIDF_PATH=/home/diegolagos/esp-idf -DIDF_TARGET=esp32s3 -DPYTHON_DEPS_CHECKED=1 -DPYTHON=/home/diegolagos/esp/idf-tools/python_env/idf6.1_py3.12_env/bin/python -DEXTRA_COMPONENT_DIRS= -DPROJECT_SOURCE_DIR=/home/diegolagos/esp_projects/robot_audio -DIGNORE_EXTRA_COMPONENT= -DIDF_BUILD_V2= "-GUnix Makefiles" -S /home/diegolagos/esp-idf/components/bootloader/subproject -B /home/diegolagos/esp_projects/robot_audio/build/bootloader
	cd /home/diegolagos/esp_projects/robot_audio/build/bootloader && /usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/src/bootloader-stamp/bootloader-configure
...
bootloader-prefix/src/bootloader-stamp/bootloader-download: bootloader-prefix/src/bootloader-stamp/bootloader-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "No download step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/src/bootloader-stamp/bootloader-download

bootloader-prefix/src/bootloader-stamp/bootloader-install: bootloader-prefix/src/bootloader-stamp/bootloader-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'bootloader'"
	cd /home/diegolagos/esp_projects/robot_audio/build/bootloader && /usr/bin/cmake -E echo_append

bootloader-prefix/src/bootloader-stamp/bootloader-build:
.PHONY : bootloader-prefix/src/bootloader-stamp/bootloader-build

bootloader-prefix/src/bootloader-stamp/bootloader-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'bootloader'"
	/usr/bin/cmake -Dcfgdir= -P /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/tmp/bootloader-mkdirs.cmake
	/usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/src/bootloader-stamp/bootloader-mkdir
...
bootloader-prefix/src/bootloader-stamp/bootloader-patch: bootloader-prefix/src/bootloader-stamp/bootloader-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/src/bootloader-stamp/bootloader-patch
...
bootloader-prefix/src/bootloader-stamp/bootloader-update: bootloader-prefix/src/bootloader-stamp/bootloader-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/diegolagos/esp_projects/robot_audio/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No update step for 'bootloader'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /home/diegolagos/esp_projects/robot_audio/build/bootloader-prefix/src/bootloader-stamp/bootloader-update
