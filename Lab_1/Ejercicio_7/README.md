...
Actualmente, dentro de `Ejercicio_7/` no hay un proyecto ESP-IDF compilable (la carpeta `esp32-camera/` está vacía en este workspace). Por lo tanto, este ejercicio **no se puede compilar/flash** directamente desde aquí.
